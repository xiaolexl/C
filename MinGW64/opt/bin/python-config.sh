...
prefix_build="/i/mingw-builds/x86_64-1140-posix-seh-msvcrt-rt_v11/mingw64/opt"
...
CFLAGS=$(echo "-O2 -pipe -fno-ident -I/i/mingw-builds/x86_64-1140-posix-seh-msvcrt-rt_v11/mingw64/opt/include -I/i/mingw-builds/prerequisites/x86_64-zlib-static/include -I/i/mingw-builds/prerequisites/x86_64-w64-mingw32-static/include -fwrapv -DNDEBUG -D__USE_MINGW_ANSI_STDIO=1" | sed "s#$prefix_build#$prefix_real#")
VERSION="2.7"
LIBM="-lm"
LIBC=""
SYSLIBS="$LIBM $LIBC"
